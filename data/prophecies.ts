...
export const prophecies: Prophecy[] = [
  ...
  },
  {
    ...
    reveal: {
      ...
      history: "The four kingdoms map identically to the statue, now seen as predatory beasts. The ten horns are the ten Germanic kingdoms that divided Rome (Visigoths, Vandals, Ostrogoths, etc.). The little horn uprooted three kingdoms (Heruli 493, Vandals 534, Ostrogoths 538) and ruled for 1,260 years (538–1798 AD), exactly 'a time, times and half a time' using the biblical day-year principle. This is not speculation. It is verified secular history.",
  ...
  },
  {
    ...
    reveal: {
      what: "A ram with two horns (one higher than the other) charges westward, northward, southward, and none can stop it. Then a goat comes from the west with a single conspicuous horn, strikes the ram, breaks its two horns, and becomes great. The great horn breaks and four horns grow in its place. From one of these four comes a little horn that grows exceedingly great, casts down truth, and defiles the sanctuary for 2,300 days.",
