...
export const doctrines: DoctrinePage[] = [
        ...
        contentBlocks: [
          {
            ...
            text: "Historicist exegesis reads the 70 weeks as one unbroken 490-year period beginning in 457 BC. This places Christ's baptism at 27 AD, His crucifixion at 31 AD (the midst of the 70th week), and the gospel's expansion to the Gentiles at 34 AD. Every event fits with precision. No gap is required, or supported by the text.",
          },
          {
    ...
    sections: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          {
            label: "Matthew 24, what Jesus said",
  ...
  },
  {
    slug: "antichrist-development",
    title: "Antichrist Study Development",
    subtitle: "The word 'Anti' means 'In Place Of', a counterfeit, more than an opponent",
    scriptureRef: "1 John 2:18-19, Acts 20:27-32",
    category: "antichrist",
    intro: "The term 'Antichrist' often carries mystery and fear. To understand its biblical meaning, go back to the original context, to the warnings of the apostles and the historical challenges the early church faced.",
    sections: [
      {
        id: "origin",
        ...
        contentBlocks: [
          {
            ...
            text: "John warns that 'many antichrists' had already appeared in his day. The spirit of antichrist is more than a future individual. It is a persistent force operating even within the early church context. It was not a distant threat. It was a present reality.",
          },
        ],
        keyVerse: {
        ...
        contentBlocks: [
          {
            ...
            text: "Paul warned the elders at Ephesus that 'fierce wolves' would arise from among themselves. The danger was not only external persecution from Rome. It was internal departure from the truth. The 'twisted things' spoken by these leaders would draw away disciples after them.",
          },
        ],
      },
      {
