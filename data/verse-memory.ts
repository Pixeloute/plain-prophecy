...
export const verseMemoryCards: VerseMemoryCard[] = [
  // ── Daniel ────────────────────────────────────────────────────────────────
  {
    ...
    contextClue:
      "After four world empires crumble, one final kingdom rises. It will never fall.",
    book: "daniel",
    theme: "Son of Man",
    christAnchor:
  ...
  },
  {
    ...
    theme: "70 Weeks",
    christAnchor:
      "The decree of 457 BC plus 483 years lands precisely on the baptism of Jesus in AD 27. It is the most exact messianic prophecy in the Bible.",
  },
  {
    id: "dan-9-27",
    ...
    contextClue:
      "In the middle of the final prophetic week, sacrifice and offering cease.",
    book: "daniel",
    theme: "70 Weeks",
    christAnchor:
  ...
  },
  {
    ...
    theme: "New Earth",
    christAnchor:
      "The Sabbath that pointed to creation and the exodus now points to the new creation. It is worship in the age to come.",
  },
  ...
  // ── Other books ───────────────────────────────────────────────────────────
  {
    ...
    contextClue:
      "In the garden, right after the fall, God declares war between the serpent and the woman's offspring, ending in one decisive blow.",
    book: "genesis",
    theme: "Messianic",
    christAnchor:
  ...
  },
  {
    ...
    theme: "Sanctuary",
    christAnchor:
      "The earthly temple was always a shadow. Christ serves in the original, the heavenly sanctuary that is the key to understanding Daniel 8:14.",
  },
  {
    id: "matt-24-14",
    ...
    theme: "Second Coming",
    christAnchor:
      "The mission of the church is not speculation about dates but proclamation. It carries the same everlasting gospel the first angel of Revelation 14 carries.",
  },
];
