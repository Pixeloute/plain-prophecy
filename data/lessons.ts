...
export const lessons: Lesson[] = [
  {
    ...
    readingTime: "7 min",
    summary:
      "The day-year principle is the hermeneutical foundation of Historicist prophecy. It is not invented. Plain Scripture states it twice, internal evidence across Daniel and Revelation confirms it, and every major time prophecy lands precisely on verifiable historical dates.",
    sections: [
      {
        heading: "What is the Day-Year Principle?",
        body: [
          "The day-year principle states that in symbolic, apocalyptic prophecy, one prophetic day represents one literal year. It is not a hermeneutical invention of the Reformers or of SDA theologians. Scripture states it twice.",
      ...
      },
      {
        ...
        body: [
          "Evangelical futurism rejects the day-year principle to compress Daniel's time prophecies into a literal 3.5-year 'Great Tribulation' inserted at the end of history. But this creates an insurmountable problem: the 70 weeks of Daniel 9.",
          "If Daniel 9's 70 weeks are literal weeks (490 days = 1.37 years), they cannot reach from Daniel's day to Christ's first coming. The math is irreconcilable. Futurism must therefore split the 70 weeks: 69 weeks literal, then a 2,000-year 'gap,' then the 70th week resumed at the end of time.",
          ...
          "The interpretive cost of rejecting the day-year principle is the entire prophetic structure of Daniel. The benefit of accepting it is a coherent, verifiable timeline that converges on Jesus Christ. It leads you to him.",
        ],
      },
      {
        ...
        body: [
          ...
          "The Futurist reinterpretation that abandoned the day-year principle originated with Francisco Ribera (1590), a Spanish Jesuit writing to deflect Protestant identification of the papacy with the Antichrist. This is not a Protestant innovation. It is a Counter-Reformation reinterpretation that entered Protestantism only in the 19th century through John Nelson Darby.",
        ],
      },
    ],
    keyDates: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "Seven Weeks and Sixty-Two Weeks: 483 Years to Messiah",
        body: [
      ...
      },
      {
        ...
        body: [
          ...
          "Daniel's prophecy predicted the theological turning point as well as the dates: the Messiah would come, be cut off, confirm the covenant, and the focus would broaden beyond Israel. Every element was fulfilled in precise sequence.",
        ],
      },
      {
        ...
        body: [
          ...
          "If the 70th week is still future, then Christ did not confirm the covenant in the middle of the 70th week, which leaves 31 AD theologically un-anchored in Daniel. The Historicist reading is internally coherent. The Futurist reading requires a grammatically unsupported gap to make the text fit a system it was never designed to support.",
        ],
      },
    ],
    keyDates: [
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Secular historians date the establishment of papal temporal power to this exact period. It is not a date calculated backward from 1798. Historians of the late Roman and early medieval period document it independently.",
        ],
      },
      {
    ...
    sections: [
      {
        ...
        body: [
          "Daniel 7 describes the little horn with careful specificity. A responsible interpretation must identify a power that matches all of these characteristics, not some.",
          "1. It rises from the fourth kingdom (Rome), not from Greece or Persia or Babylon.",
          "2. It arises after the ten horns (the ten Germanic kingdoms that divided Rome in the 5th and 6th centuries AD).",
          ...
          "5. It 'speaks great words against the Most High,' making blasphemous claims.",
          "6. It 'wears out the saints,' a long period of persecution.",
          "7. It 'thinks to change times and laws,' claiming authority to alter divine ordinances.",
      ...
      },
      {
        ...
        body: [
          ...
          "3. Diverse from other kingdoms: a theocratic religious institution claiming spiritual and temporal authority, unlike any secular kingdom.",
          "4. Uprooted three horns: the Heruli (493 AD), Vandals (534 AD), and Ostrogoths (538 AD) were all destroyed because they were Arian Christians who opposed papal supremacy. Secular history confirms all three were removed in direct connection with the establishment of papal authority.",
      ...
      },
      {
        ...
        body: [
          ...
          "But this candidate fails on multiple criteria. No future individual can satisfy criterion 4 (uprooting three specific Germanic kingdoms), because those kingdoms ceased to exist in the 6th century. No future individual can satisfy criterion 8 (1,260 years) if the period is taken literally as 3.5 years. A single ruler cannot 'wear out the saints' in 3.5 years the way the prophetic language implies.",
          ...
          "Futurism arose as a systematic theology in Jesuit circles (Ribera, 1590, and Lacunza, 1812) to counter the Reformation identification. It entered Protestant circles in the 19th century. This historical origin does not make it wrong, but it should prompt careful scrutiny of whether the exegesis or the apologetic agenda is driving the interpretation.",
        ],
      },
    ],
    keyDates: [
  ...
  },
  {
    ...
    subtitle: "What Daniel 8:14 means, and why it matters for us now",
    symbol: "⚖️",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "This is consistent with the legal logic of Scripture. Before an executive act (the Second Coming), there is a judicial act (the heavenly judgment). Jesus does not return with his reward until each case has been decided: 'Behold, I come quickly; and my reward is with me, to give every man according as his work shall be' (Rev 22:12).",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Francisco Ribera (1537–1591) published a 500-page commentary on Revelation in 1590. His key move: restrict the first few chapters of Revelation to ancient Rome, and push everything else into the distant future. He set a 3.5-year period at the end of time, involving a future individual Antichrist who would deny Christ, rebuild the Jewish temple, abolish Christianity, and claim to be God. This became 'Futurism.'",
