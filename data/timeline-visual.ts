...
export interface PeriodBand {
  ...
  bandIndex: number // 0, 1, 2 control vertical stacking below axis
}
...
const futuristEvents: TimelineEvent[] = [
  {
    ...
    shortLabel: '4 BC',
    desc: 'The Word becomes flesh. Futurists agree that Christ\'s birth, life, and ministry are foundational. Divergence begins in how the 70 weeks of Daniel 9 are interpreted. Most futurists see 69 of the 70 weeks as fulfilled by the cross, with the 70th week deferred to the future.',
  ...
  },
  {
    id: 'fut-church-age',
    year: 100,
    dateLabel: 'Church Age (33 AD to present)',
    label: 'Church Age',
    shortLabel: 'Church',
  ...
  },
  {
    ...
    desc: 'A literal 1,000-year reign of Christ on earth from Jerusalem. Israel is restored as the central nation. This earthly, political millennium is a key distinctive of dispensational futurism, contrasted with the historicist view of the millennium as in heaven after the Second Coming.',
...
const preteristEvents: TimelineEvent[] = [
  {
    ...
    label: 'Incarnation of Christ',
    shortLabel: '4 BC',
    desc: 'The preterist framework agrees with historicists that Christ\'s life and ministry are the centrepiece of prophecy. It diverges by locating the fulfilment of most New Testament and Daniel prophecies before 70 AD.',
    refs: 'Luke 2:1–7 · John 1:14',
    badge: 'historical',
    tier: 2,
    labelRow: 4,
