    ...
    cells: [
      {
        ...
        description:
          "Two arms mirror the Medo-Persian coalition, strong but not as unified as Babylon. Silver is valuable yet less than gold: a vast empire, but more diffuse in its authority.",
      },
      {
        visionId: "daniel-7",
        present: true,
      ...
      },
      {
        ...
        description:
          "Gabriel interprets this directly. This is the only empire named explicitly in Daniel 8. One horn taller than the other, again capturing Persia's dominance over its Median partner.",
      },
      {
        visionId: "revelation-13",
        present: true,
  ...
  },
  {
    ...
    cells: [
      ...
      },
      {
        ...
        description:
          "Greece's restless speed and cultural penetration form the body of the composite beast. Hellenism's language and culture saturated every empire that came after it, Rome included.",
      },
    ],
  },
  {
    ...
    textColor: "light",
    convergenceNote:
      "Four visions, four different symbols, all pointing to the same iron empire. Daniel 7 doesn't even give it an animal name. Rome defied every natural category.",
    cells: [
      {
        visionId: "daniel-2",
        present: true,
