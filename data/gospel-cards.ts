...
export const gospelCards: GospelCard[] = [
  {
    ...
    reveal: {
      ...
      why: "The incarnation is not a side story. It is the hinge of all history. Everything God wanted to say about himself, he said in a person. Jesus is the message and the messenger at once. 'Whoever has seen me has seen the Father' (John 14:9).",
  ...
  },
  {
    ...
    reveal: {
      ...
      love: "'Christ has been raised from the dead, the firstfruits of those who have fallen asleep' (1 Cor 15:20). The word 'firstfruits' means he is first, not last. Everyone connected to him follows. The resurrection is not his alone. It is the guarantee of ours. Love that is stronger than death is the only love worth trusting with your life.",
    },
  },
  {
    id: "grace",
  ...
  },
  {
    ...
    subtitle: "God with you, not only God for you",
    symbol: "🕊",
    ...
    reveal: {
      ...
      love: "'I will ask the Father, and he will give you another Advocate to help you and be with you forever' (John 14:16). Jesus did not save us and leave. He sent someone to stay. The Spirit is God's presence in the mess of your daily life. Love that does not only come through in the big moments.",
    },
  },
  {
    id: "adoption",
  ...
  },
  {
    ...
    number: 8,
    title: "New Creation",
    subtitle: "The Gospel is not only forgiveness. It is transformation",
    symbol: "🌱",
    scripture: "2 Corinthians 5:17",
    href: "/studies/gospel/jesus-at-the-centre",
    reveal: {
      what: "'If anyone is in Christ, the new creation has come: the old has gone, the new is here!' (2 Cor 5:17). The Gospel does not only cover over who you were. It begins the process of making you into someone new. Salvation is not a patch on a broken life. It is the beginning of a rebuilt one.",
