...
export const pillars: PillarCard[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Key Hebrew: šābûaʿ (שָׁבוּעַ) = "week" or "seven", a unit of seven that shifts between days or years depending on context, exactly as the day-year principle demands.',
    ],
  },
  {
    num: '03',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'The concept of two separate returns of Christ (first secret, then public 7 years later) has no biblical text that explicitly states it. Every "rapture" proof text reads naturally as the singular Second Coming (Matt 24:30–31, 1 Cor 15:52, Rev 1:7).',
...
export const preteristWeaknesses = [
  ...
  'Full preterism requires the resurrection to be past, contradicting 1 Cor 15 written before 70 AD',
  'Renders 2,000 years of church history prophetically irrelevant, the same problem as Futurism',
  ...
  'Rejects the day-year principle, leaving the time prophecies of Daniel and Revelation without a consistent hermeneutical rule',
];
