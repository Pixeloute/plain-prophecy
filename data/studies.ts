    ...
    lessons: [
      {
        ...
        sections: [
          ...
          },
          {
            ...
            body: "God gave them singular learning and skill. At their graduation three years later, Nebuchadnezzar found them 'ten times better' than all the magicians and enchanters in his kingdom. Daniel's influence would span the entire duration of the Babylonian empire and into the Medo-Persian era (v.21).",
          },
        ],
        christCentre:
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            body: "",
            contentBlocks: [
              { label: "The Prophecy", text: "\"A fourth kingdom, strong as iron, because iron breaks in pieces and shatters all things.\" No imagery of inferiority here, iron is described as the strongest material. And two legs: Rome would eventually split. (Daniel 2:40)" },
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            body: "The 70 weeks divide into three segments. First, 7 weeks (49 years) for the rebuilding of Jerusalem. Then 62 weeks (434 years) to 'Messiah the Prince'. Then 1 final week (7 years) in which the covenant is confirmed and sacrifice ceases. Total: 490 years from 457 BC. Note that the 70th week is not a future event separated by a 2,000-year gap. That interpretation requires inserting a parenthesis the text does not contain. The 70 weeks run continuously, culminating in 34 AD when the gospel formally extends to the Gentiles.",
          },
          {
  ...
  },
  {
    ...
    lessons: [
        ...
        sections: [
          {
            ...
            contentBlocks: [
              ...
              {
                label: "ἀγάπη / agapē",
                text: "Unconditional, self-giving love. Used 116 times in the NT. It defines God's essential nature (1 John 4:8).",
              },
              {
                label: "ἀγαπάω / agapaō",
        ...
        sections: [
          {
            ...
            contentBlocks: [
              ...
              },
              {
                ...
                text: "Righteousness, right standing, justice. Romans 1:17, 'the righteousness of God is revealed', not our righteousness, but His. The word describes a legal and relational status, not merely moral behaviour.",
              },
              {
          ...
          },
          {
            ...
            contentBlocks: [
              ...
              },
              {
                ...
                text: "Second-century apocryphal accounts of the resurrection describe elaborate visions, Jesus emerging from the tomb in overwhelming glory. Mark's account is plain and unadorned: women, an empty tomb, a young man in white, fear. That is how eyewitness testimony looks. That is not how legend reads.",
              },
              {
            ...
            contentBlocks: [
              {
                ...
                text: "The empty tomb proves something extraordinary happened. The post-resurrection appearances establish what. The 1 Corinthians 15 creed names specific individuals: Peter, the twelve, then more than 500 at once. 'Most of whom are still alive' is not a casual aside. It is an explicit legal invitation: go and verify this with living witnesses. This is testimony language, not mythology.",
              },
              {
          ...
          },
          {
            ...
            contentBlocks: [
              ...
              },
              {
                ...
                text: "Because death is defeated, we can live without fear. Because Christ is Lord, we can live with purpose. The resurrection is not merely a past event. It is the foundation of the present life.",
              },
            ],
          },
        ],
      ...
      },
      {
        ...
        intro:
          "The Bible is not a collection of inspiring stories, moral lessons, and prophecies about world events. It is one story, and it has one hero. Reading the Bible without finding Jesus is not merely missing the point. Jesus says it is missing the entire purpose.",
        sections: [
          {
          ...
          },
          {
            ...
            contentBlocks: [
              ...
              },
              {
                ...
                text: "\"I am the Alpha and the Omega, the first and the last, the beginning and the end.\" Jesus is not merely the beginning and end chronologically. He is the interpretive lens of everything in between.",
              },
            ],
          },
          {
          ...
          },
          {
            ...
            contentBlocks: [
              ...
              },
              {
                ...
                text: "This sounds reasonable, but it has a fatal problem: no New Testament author ever makes it. Not one apostle, in any letter or sermon, connects the resurrection to a change of the weekly worship day. The resurrection is celebrated in the NT, but it is celebrated every day (Acts 2:46 records daily breaking of bread, Romans 6:4 casts baptism as resurrection participation), not specifically on Sunday. The connection of the resurrection to Sunday as a worship day is a post-apostolic inference, not apostolic instruction.",
              },
              {
      ...
      },
      {
        ...
        sections: [
          {
            ...
            contentBlocks: [
              ...
              },
              {
                ...
                text: "John is the only biblical author to use the specific word 'antichrist.' He notes that 'many antichrists have appeared' already in his day. This tells us the spirit of antichrist is more than a future threat. It is an active principle operating inside the history of the church.",
              },
            ],
          },
          {
        ...
        christCentre: "The study of the Antichrist is not about evil. It is about protecting the true Christ. You name the counterfeit only so you can cling more tightly to the original. Jesus is the only Mediator, the only High Priest, the only Head of the Church. Any person, power, or tradition that tries to occupy that space, even with the best of intentions, works in the spirit of antichrist. And the counterfeit's whole aim is to bury the good news about Jesus and pull your worship onto itself. Your safety is not in tracking every move of the enemy. It is in knowing the voice of the Shepherd so well that no substitute can fool you.",
        ...
        sections: [
          ...
          },
          {
            ...
            contentBlocks: [
              {
                label: "The Prophecy",
                text: "'Who has believed our report? And to whom has the arm of the LORD been revealed?' The Servant grew up 'like a root out of dry ground', in obscurity, without outward majesty. He was despised and rejected, a man of sorrows acquainted with grief. The people hid their faces from him, and he was not esteemed.",
              },
              {
                label: "NT Fulfilment",
        ...
        sections: [
          {
            ...
            contentBlocks: [
              ...
              },
              {
                ...
                text: "The verb translated 'determined' (neḥtak) carries the literal sense 'cut off', pointing to the 490 years being cut off from the longer 2,300-year prophecy of Daniel 8:14. Adventist scholars (Maxwell, Shea, Pfandl) read both prophecies as anchored at the same starting point: the decree of Artaxerxes in 457 BC.",
              },
            ],
          },
          {
          ...
          },
          {
            ...
            contentBlocks: [
              ...
              },
              {
                ...
                text: "The strongest evidence is not Christian exegesis but Jewish translation. The Septuagint, the Greek translation of the Hebrew Bible produced by Jewish scholars in Alexandria in the 3rd century BC, two centuries before Christ, renders almah as parthenos, the unambiguous Greek word for virgin. This was a Jewish translation choice made long before any Christian apologetic existed. The LXX translators understood what Isaiah meant.",
              },
            ],
          },
          {
            ...
            contentBlocks: [
              {
                ...
                text: "In the ancient Near East, every royal entry carried a clear symbolic vocabulary: a king entering a city on a horse was coming for war, and a king entering on a donkey was coming in peace. Solomon had ridden a royal mule to his own anointing (1 Kings 1:33). Zechariah's specification of a donkey, the foal of a donkey, was not incidental colour but a deliberate peace-arrival signal. The king comes to save, not to conquer by force.",
              },
              {
        ...
        sections: [
          ...
          },
          {
            ...
            contentBlocks: [
              {
                label: "The Prophecy",
                text: "'They divide my garments among them, and for my clothing they cast lots.' The specificity is striking: not merely that the victim's clothes are taken, but that lots are cast for a specific garment, implying it was too valuable to divide but worth gambling over.",
              },
              {
                label: "NT Fulfilment",
        ...
        sections: [
          ...
          },
          {
            ...
            contentBlocks: [
              ...
              {
                label: "The Logic",
                text: "Peter's argument is not mystical. It is historical and textual. He reasons from three premises. (1) David wrote Psalm 16. (2) David died and his body decomposed. (3) Therefore David was prophesying about someone else whose body would not decompose. The resurrection of Jesus is the only event in history that satisfies premise 3. The empty tomb is not merely a claim. It is the fulfilment of a 1,000-year-old prophetic logic.",
              },
            ],
          },
          {
            ...
            contentBlocks: [
              ...
              },
              {
                ...
                text: "For both Peter and Paul, the resurrection is not primarily a miracle performed to prove Jesus is mighty. It is the fulfilment of a prophetic necessity. It had to happen because Psalm 16 said it would. The resurrection was not an afterthought to the cross. It was the prophetic plan. Every Easter morning is the answer to a thousand-year-old question embedded in a psalm of trust.",
              },
            ],
          },
        ],
