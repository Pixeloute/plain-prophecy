...
export const scoringCriteria: ScoringRow[] = [
  {
    ...
    preteristPosition: 'Generally rejects the day-year principle. Reads time periods literally but applies them to 1st-century events, so "3.5 years" means the Roman-Jewish War period, not 1,260 literal years of history.',
  ...
  },
  {
    ...
    futuristPosition: 'Inserts a 2,000+ year gap between week 69 and week 70, with no textual basis. Antichrist fulfils week 70 in the future.',
    preteristPosition: 'Reads all 70 weeks as contiguous (457 BC–34 AD), agreeing with Historicism on this point. It then applies the subsequent prophetic imagery to the destruction of Jerusalem in 70 AD rather than to a continuing church-history fulfilment.',
    sdaPosition: 'All 70 weeks are contiguous (457 BC–34 AD). Jesus confirms the covenant (v.27). Cross ends sacrifice. Stephen\'s stoning falls in 34 AD. Historically verified at every data point.',
  ...
  },
  {
    ...
    preteristPosition: 'Partial preterists retain a future bodily Second Coming. Full preterists assert the resurrection was a spiritual event already fulfilled in 70 AD. That position directly contradicts 1 Cor 15:51–54 and 1 Thess 4, where Paul writes as though resurrection is still future.',
  ...
  },
  {
    ...
    preteristPosition: 'Identifies the "little horn" of Daniel 8 as Antiochus Epiphanes and the Antichrist of Revelation as Nero Caesar or the Roman Empire. It has some historical grounding, but Antiochus and Nero lack the full diagnostic profile: neither "changed times and law" nor exercised the 1,260-year dominance Daniel 7:25 requires.',
    sdaPosition: 'The "little horn" is papal Rome (also identified by Luther, Calvin, Wesley, Newton). All diagnostic markers match: speaks against God, wears out saints, changes times and law, 1,260 years of dominance.',
    futuristScore: 3, futuristClass: 'score-low',
    preteristScore: 5, preteristClass: 'score-mid',
    sdaScore: 9, sdaClass: 'score-high',
  },
  ...
  },
  {
    ...
    futuristPosition: 'Futurism was first developed by Jesuit priest Francisco Ribera (1590 AD) as a Counter-Reformation move to deflect Protestant identification of Rome as Antichrist. Popularised by Darby (1830s), with no patristic support.',
  ...
  },
  {
    ...
    preteristPosition: 'Preterism is genuinely Christ-centred in anchoring prophecy to the historical ministry of Jesus and the Cross. Its weakness is telescoping eschatology entirely into the 1st century, reducing Christ\'s ongoing priestly and kingly role to a past event rather than a living, present reality.',
  ...
  },
  {
    ...
    preteristPosition: 'Full preterists typically embrace amillennialism, where the millennium is the entire church age, already ongoing. Partial preterists hold similar amillennial or postmillennial views. Neither position is explicitly supported by Revelation 20\'s language, which speaks of "thrones" and a binding of Satan for a literal 1,000-year period.',
  ...
  },
  {
    ...
    preteristPosition: 'Preterism applies Revelation exclusively to the 1st-century Roman world and the fall of Jerusalem. This gives it historical grounding for that era, but leaves the entire subsequent 2,000 years of church history without prophetic relevance: persecutions, Reformation, global mission. Revelation becomes a sealed historical letter rather than a living word to the church.',
    sdaPosition: 'Revelation speaks to real persecuted churches (1st century), through the Reformation, into the modern age. The seven churches (Rev 1–3) stand for seven historical eras. Seven seals and seven trumpets trace church history unfolding.',
    futuristScore: 3, futuristClass: 'score-low',
    preteristScore: 4, preteristClass: 'score-low',
    sdaScore: 8, sdaClass: 'score-high',
  },
...
export const preteristDeductions: DeductionItem[] = [
  ...
  },
  {
    ...
    reason: '70 AD is among the most thoroughly documented events in ancient history. Josephus, Tacitus, and Roman military records converge. Preterism deserves credit for grounding prophecy in verifiable history. The score reflects that squeezing all of Revelation\'s seals, trumpets, and bowls into a single 3.5-year siege requires significant interpretive compression, and some identifications are strained.',
  },
  {
...
export const sdaDeductions: DeductionItem[] = [
  {
    ...
    reason: "Numbers 14:34 and Ezekiel 4:6 provide explicit textual grounding, the strongest element of the Historicist case. The single point deducted reflects a genuine scholarly debate: both texts use the day-year equivalence in a specific narrative context, and some exegetes question whether they constitute a universal hermeneutical rule applicable to all apocalyptic prophetic time-periods. The principle is explicitly stated. Its universal scope requires an additional inference.",
  },
  {
